...
.co-src__chip[data-state="active"]{border-color:hsl(268 73% 51% / .45)}
.co-src__orb{width:.55rem;height:.55rem;border-radius:50%;background:hsl(268 80% 55%);box-shadow:0 0 0 0 hsl(268 80% 55% / .5);animation:co-orb 1.4s ease-out infinite}
.co-src__bar{height:3px;border-radius:2px;background:hsl(268 73% 51%);transition:width .4s ease}
...
@keyframes co-orb{0%{box-shadow:0 0 0 0 hsl(268 80% 55% / .5)}70%{box-shadow:0 0 0 .5rem hsl(268 80% 55% / 0)}100%{box-shadow:0 0 0 0 hsl(268 80% 55% / 0)}}
