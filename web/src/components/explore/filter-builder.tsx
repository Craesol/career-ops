...
.co-fb__chip.inc{color:hsl(268 78% 42%);background:hsl(268 73% 51% / .11);border-color:hsl(268 73% 51% / .26)}
html.dark .co-fb__chip.inc{color:hsl(268 86% 70%);background:hsl(268 80% 55% / .14);border-color:hsl(268 80% 55% / .28)}
