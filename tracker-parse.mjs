...
// ── Fork-local section (Craesol/career-ops) ─────────────────────────────────
// Upstream keeps REQ_NUMBER_RE/extractReqNumber private inside merge-tracker.mjs;
// this fork centralizes them here so dedup-tracker and followup-cadence share
// ONE definition (see 5b72e0f, #1524/#2009 parity). Do not remove on update.
